...
<center>
<br></br>
	<form  action="guardar_sector_cosecha.php" method="POST"  class="form-register">
    ...
    <input type="text" REQUIRED name="costo" placeholder="Costo de Produccion..." value="" class="input-50">
