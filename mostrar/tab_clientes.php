...
<nav class="navbar navbar-toggleable-md navbar-inverse bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../altas/formulario_cliente.php"> Añadir Nuevo Cliente </a>
      </li>
      </ul>
      <ul class="navbar-nav ml-auto">
      <form action="buscar/tab_clientes.php" method="POST"  class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="text" REQUIRED name="nombre" placeholder="Search">
      <button class="btn btn-secondary" type="submit">Buscar</button>
    </form>
      <li class="nav-item">
        <a class="nav-link" href="PDF/pdf_clientes.php"> Generar PDF </a>
      </li>
      </ul>
      </div>
      </nav>
