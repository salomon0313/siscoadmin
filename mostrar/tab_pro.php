...
?>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
       ...
       <li class="nav-item">
        <a class="nav-link" href="tab_sector.php"> Atrás </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../altas/formulario_procesos.php?id_sector=<?php echo $row['id_sector']; ?>"> Añadir Nuevo Proceso </a>
      </li>
      ...
      <ul class="navbar-nav ml-auto">
       <form action="buscar/tab_pro_B.php?id_sector=<?php echo $row['id_sector']; ?>" method="POST"  class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="text" REQUIRED name="nombre" placeholder="Search">
      <button class="btn btn-secondary" type="submit">Buscar</button>
    </form>
      <li class="nav-item">
        <a class="nav-link" href="PDF/pdf_procesos.php?id_sector=<?php echo $row['id_sector']; ?>"> Generar PDF  </a>
      </li>
      </ul>
      </div>
      </nav>
...
<tr>
  ...
  $numero=$row['costo_total'];
	...
	?>
	<td><a href="eliminar/eliminar_pro.php?id_procesos=<?php echo $row['id_procesos']; ?>"><img src="../imagenes/det.png"></a></td>
