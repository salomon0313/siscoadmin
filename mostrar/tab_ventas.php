...
<nav class="navbar navbar-toggleable-md navbar-inverse bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="tab_inventas.php"> Atrás </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../altas/formulario_venta.php?id_sector=<?php echo $row['id_sector']; ?>"> Añadir Nueva Venta  </a>
      </li>
      </ul>
      <ul class="navbar-nav ml-auto">
          <form action="buscar/tab_ventas_B.php?id_sector=<?php echo $row['id_sector']; ?>" method="POST"  class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="text" REQUIRED name="nombre" placeholder="Search">
      <button class="btn btn-secondary" type="submit">Buscar</button>
    </form>
      <li class="nav-item">
        <a class="nav-link" href="PDF/pdf_ventas_sec.php?id_sector=<?php echo $row['id_sector']; ?>"> Generar PDF  </a>
      </li>
      </ul>
      </div>
      </nav>
